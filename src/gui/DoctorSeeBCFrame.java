...
public class DoctorSeeBCFrame extends JFrame {
	...
	public DoctorSeeBCFrame(String pid) {
		initGUI(pid);
	}
    ...
    private void initGUI(String pid) {
        ...
        jbtNew = new JButton("新建体检报告");
        jbtDetail = new JButton("查看 / 修改报告");
        jbtDelete = new JButton("删除体检报告");
        jbtQuit = new JButton("退出");

        // 向表格中添加体检报告信息
        bodyChecks = BodyCheckDAO.getBodyCheckList(pid);
        ...
        jbtSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (strDate.isEmpty()) {
                    ...
                    // 重新获取体检报告列表
                    bodyChecks = BodyCheckDAO.getBodyCheckListByDate(pid, strDate);
                    // 更新数据
                    fillRows();
                    // 修改表格数据
                    ((DefaultTableModel) jt1.getModel()).fireTableDataChanged();
        ...
        jbtNew.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                // 创建一个空体检报告对象
                NewBodyCheckFrame newBodyCheck = new NewBodyCheckFrame(pid);
            }
        });
        ...
        jbtDetail.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (index > -1) {
                    ...
                    BodyCheckFrame bcf2 = new BodyCheckFrame(true, str);
                }
            }
        });
        ...
        jbtDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (choice == JOptionPane.YES_OPTION) {
                    ...
                    if (index > -1) {
                        String str = (String) jt1.getValueAt(index, 0);
                        int result = BodyCheckDAO.delete(str);
                        if (result > 0) {
